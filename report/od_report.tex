...
where $M$ is an object in $\cathask$\footnotemark. This can be implemented as a
Haskell function which allows the merging of two $\cathask$ instances into a
single \emph{combined instance}.
%
...
over the $\cathask$ category. Thus, $\mu$ is scoped correctly as a natural
transformation over functors in the categorical product of types.}
%
